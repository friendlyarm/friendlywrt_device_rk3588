...
# Kernel
#
TARGET_KERNEL_CONFIG="nanopi6_linux_defconfig friendlywrt.config kvm.config"
...
TARGET_SD_RAW_FILENAME=friendlywrt_23.05_$(date +%Y%m%d)_rk3588_arm64_sd.img
TARGET_EFLASHER_RAW_FILENAME=friendlywrt_23.05_$(date +%Y%m%d)_rk3588_arm64_eflasher.img
