...
TARGET_SD_RAW_FILENAME=friendlywrt_25.12_$(date +%Y%m%d)_rk3588_arm64_sd.img
TARGET_EFLASHER_RAW_FILENAME=friendlywrt_25.12_$(date +%Y%m%d)_rk3588_arm64_eflasher.img
